...
const URI1 =
  "data:application/json;base64,";
describe("Catos", function () {
  async function HelloWorld() {
    ...
    await catos.addPet(draw.address);
    return { catos, draw };
  }
  describe("Pets Contract", () => {
    it("Should return true for a pet contract alreafy added", async () => {
      const { catos, draw } = await loadFixture(HelloWorld);
      expect(await catos.getPet(draw.address)).to.equal(true);
    });
    it("Should return false for a pet contract not added", async () => {
      const { catos } = await loadFixture(HelloWorld);
      expect(
        await catos.getPet("0xEab5F7eF9dE6981A8CbEa82Ee2B80f0522721997")
      ).to.equal(false);
    });
  });
  describe("Mint", () => {
    ...
    it("Should reverted with No contract for this pet", async () => {
      const { catos, draw } = await loadFixture(HelloWorld);
      ...
      ).to.be.revertedWith("No contract for this pet");
    });
